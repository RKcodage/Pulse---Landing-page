            ...
            <div className="mb-3 pb-3 border-b border-gray-800/50">
              ...
              <div className="space-y-0.5">
                ...
                >
                  ...
                  <div>
                    <div className="font-medium text-sm">Gestion d'équipe</div>
                    <div className="text-xs text-gray-400 group-hover:text-gray-300 transition-colors">
                      Gérez votre équipe
                    </div>
                  </div>
                ...
                >
                  ...
                  <div>
                    <div className="font-medium text-sm">Analyse</div>
                    <div className="text-xs text-gray-400 group-hover:text-gray-300 transition-colors">
            ...
            <div className="mb-3 pb-3 border-b border-gray-800/50">
              ...
              <div className="space-y-0.5">
                ...
                >
                  ...
                  <div>
                    <div className="font-medium text-sm">Tutoriels</div>
                    <div className="text-xs text-gray-400 group-hover:text-gray-300 transition-colors">
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-xs text-gray-400 group-hover:text-gray-300 transition-colors">
                      Les dernières nouvelles et conseils
                    </div>
                  </div>
                  <ChevronRight className="ml-auto h-3 w-3 text-gray-500 group-hover:text-gray-300 transition-colors" />
                </Link>
            ...
            <div className="mb-3 pb-3 border-b border-gray-800/50">
              <div className="grid grid-cols-2 gap-1">
                ...
                >
                  ...
                  <span className="font-medium text-sm">Tarifs</span>
                </Link>
                <Link
                  href="#testimonials"
                  className="flex items-center py-2 px-3 text-gray-200 rounded-lg hover:bg-gray-800 transition-all duration-200 group"
